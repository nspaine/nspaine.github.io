...
const Home = () => {
    ...
    return (
        ...
        <div
            className="flex flex-col md:flex-row w-full h-full items-center justify-between px-2 md:px-10 overflow-x-hidden overflow-y-auto relative pb-32 gap-4 md:gap-0"
            style={{ zIndex: 10, isolation: "isolate" }}
        >

            {/* MOBILE: Profile Card First (Full Width) */}
            <div className="w-full md:hidden shrink-0 relative z-[100] px-4 pt-4">
                <div className="bg-black/70 p-6 rounded-2xl text-center w-full shadow-[0_0_50px_rgba(255,215,0,0.15)] backdrop-blur-sm">
                    <div className="w-32 h-32 mx-auto rounded-full overflow-hidden border-2 border-[var(--accent-color)] mb-4 shadow-[0_0_30px_rgba(255,215,0,0.3)] bg-neutral-900 flex items-center justify-center">
                        <img
                            src={profileImg}
                            alt="Nigel Paine"
                    ...
                    <h1 className="text-2xl font-black text-white mb-2 tracking-wide uppercase font-[Orbitron] drop-shadow-md">
                        Nigel Paine
                    </h1>
                    ...
                    <a
                        ...
                        className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-[#0077b5] text-white hover:bg-[#006399] transition-all hover:scale-110 shadow-lg cursor-pointer mx-auto"
                    >
                        <Linkedin size={20} />
                    </a>
                </div>
            ...
            <div className="w-full md:hidden flex flex-row justify-center items-center gap-4 relative z-50">
                ...
                <div
                    className="cursor-pointer group flex items-center p-3 transition-transform hover:translate-x-1 bg-black/70 rounded-lg backdrop-blur-sm border border-transparent hover:border-[var(--accent-color)] w-32 justify-between px-4"
                    onClick={() => navigate('/portfolio')}
                >
                    <ChevronLeft className="w-10 h-10 text-[var(--accent-color)] shrink-0" />
                    <Cpu className="w-10 h-10 text-[var(--accent-color)] shrink-0" />
                </div>
                ...
                >
                    <Building2 className="w-10 h-10 text-[var(--accent-color)] shrink-0" />
                    <ChevronRight className="w-10 h-10 text-[var(--accent-color)] shrink-0" />
                </div>
            </div>
